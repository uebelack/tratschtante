...
describe('classic formatter', () => {
  it('should format', () => {
    ...
    })).toEqual('[2022-01-17T20:44:58.000Z][debug   ] Anim velit aliqua sunt deserunt ipsum anim mollit dolor dolore aliqua.');
    expect(classic({
    ...
    })).toEqual('[2022-01-17T20:44:58.000Z][info    ] test - Anim velit aliqua sunt deserunt ipsum anim mollit dolor dolore aliqua.\nStacktrace');
  });
});
