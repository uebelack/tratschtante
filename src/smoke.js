...
logger.error('Laboris aliquip sunt cillum officia sit aliqua officia id eiusmod sint irure.');
...
try {
  throw new Error('Labore esse quis commodo incididunt proident magna exercitation anim.');
} catch (e) {
  logger.error(e);
}
